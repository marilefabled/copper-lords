#!/usr/bin/env lua
-- Shadow Lineage — Shadow Module Test Runner
-- Run from project root: lua dredwork_bonds/tests/run_all.lua

local script_path = arg[0] or "dredwork_bonds/tests/run_all.lua"
...
local test_files = {
    "dredwork_bonds.tests.test_setup",
    "dredwork_bonds.tests.test_body",
    "dredwork_bonds.tests.test_career",
    "dredwork_bonds.tests.test_claim",
    "dredwork_bonds.tests.test_possessions",
    "dredwork_bonds.tests.test_bonds",
    "dredwork_bonds.tests.test_year",
    "dredwork_bonds.tests.test_mortality",
    "dredwork_bonds.tests.test_aftermath",
    "dredwork_bonds.tests.test_expectations",
    "dredwork_bonds.tests.test_witnesses",
    "dredwork_bonds.tests.test_claim_hunter",
    "dredwork_bonds.tests.test_secrets",
    "dredwork_bonds.tests.test_collusion",
}

print("========================================")
print("  SHADOW LINEAGE — Module Test Suite")
print("========================================")
